...
export default function HomeScreen({ navigation }: any) {
  ...
  return (
    ...
    >
      {/* ── Header ─────────────────────────────────────────── */}
      <LinearGradient colors={['#0D9488', '#1E3A5F', '#0F172A']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.header}>
...
const styles = StyleSheet.create({
  ...
  greetingSmall: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.6)', fontWeight: FontWeight.medium },
  ...
  bellBtn:     { marginTop: 6, width: 42, height: 42, borderRadius: 21, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center', position: 'relative' },
  bellDot:     { position: 'absolute', top: 8, right: 8, width: 8, height: 8, borderRadius: 4, backgroundColor: '#EF4444', borderWidth: 1.5, borderColor: Colors.navy },
